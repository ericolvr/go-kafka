...
import "github.com/ericolvr/gin-kafka/internal/entity"
...
type CreateProductUseCase struct {
	ProductRepository entity.ProductRespository
}

func NewCreateProductUseCase(productRepository entity.ProductRespository) *CreateProductUseCase {
